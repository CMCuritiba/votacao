...
def localhost():
	...
	env.virtualenv = '/home/alexandre.odoni/personal/python/env-votacao/'
	env.activate = '/bin/bash /home/alexandre.odoni/personal/python/env-votacao/bin/activate'
